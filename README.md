...
Dự án **không cần khóa bí mật hay tệp `.env`** nào. [`.gitignore`](./.gitignore) đã chặn sẵn mọi
dạng tệp môi trường, khóa, chứng chỉ và thông tin xác thực để không bao giờ có nguy cơ rò rỉ.
